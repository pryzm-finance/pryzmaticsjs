...
export function proposalOrderByPropertyFromJSON(object: any): ProposalOrderByProperty {
  switch (object) {
    case 0:
    case "ORDER_BY_PROPERTY_ASSET_ID":
      return ProposalOrderByProperty.ORDER_BY_PROPERTY_ASSET_ID;
    case 1:
    case "ORDER_BY_PROPERTY_PROPOSAL_ID":
      return ProposalOrderByProperty.ORDER_BY_PROPERTY_PROPOSAL_ID;
    case 2:
    case "ORDER_BY_PROPERTY_END_TIME":
      return ProposalOrderByProperty.ORDER_BY_PROPERTY_END_TIME;
    case -1:
    case "UNRECOGNIZED":
    default:
...
export function proposalOrderByPropertyToJSON(object: ProposalOrderByProperty): string {
  switch (object) {
    case ProposalOrderByProperty.ORDER_BY_PROPERTY_ASSET_ID:
      return "ORDER_BY_PROPERTY_ASSET_ID";
    case ProposalOrderByProperty.ORDER_BY_PROPERTY_PROPOSAL_ID:
      return "ORDER_BY_PROPERTY_PROPOSAL_ID";
    case ProposalOrderByProperty.ORDER_BY_PROPERTY_END_TIME:
      return "ORDER_BY_PROPERTY_END_TIME";
...
export interface ProposalOrderByProtoMsg {
  typeUrl: "/pryzmatics.database.pgov.ProposalOrderBy";
  value: Uint8Array;
}
...
export interface ProposalOrderByAminoMsg {
  type: "/pryzmatics.database.pgov.ProposalOrderBy";
