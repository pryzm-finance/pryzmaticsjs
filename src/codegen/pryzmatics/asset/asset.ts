...
export const Asset = {
  ...
  encode(message: Asset, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    ...
    if (message.delisted === true) {
      writer.uint32(160).bool(message.delisted);
    }
    return writer;
  },
